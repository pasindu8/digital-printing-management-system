    ...
    html: `
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="order-details">
              ...
              <div class="detail-row">
                ...
                <span class="detail-value">Rs. ${orderData.unit_price.toFixed(2)}</span>
              </div>
            ...
            <div class="order-details">
              ...
              <p><strong>Ordering Company:</strong> First Promovier</p>
              <p><strong>Email:</strong> ${process.env.EMAIL_FROM || process.env.EMAIL_USER}</p>
              <p><strong>Phone:</strong> +94 779 447 640</p>
          ...
          <div class="footer">
            <p>This is an automated message from First Promovier.</p>
            <p>© 2025 First Promovier. All rights reserved.</p>
          </div>
        </div>
      </body>
      </html>
...
- Unit Price: Rs. ${orderData.unit_price.toFixed(2)}
...
async function sendSupplierOrderNotification(orderData) {
  try {
    ...
    if (process.env.SEND_REAL_EMAIL !== 'true') {
      ...
      console.log(`Total: Rs. ${orderData.total_price.toFixed(2)}`);
      console.log('============================================');
