  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      <div style="text-align: center; margin-bottom: 30px;">
        <h1 style="color: #3b82f6;">Digital Printing Management</h1>
...
const generatePasswordResetEmail = (name, resetCode) => {
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      <div style="text-align: center; margin-bottom: 30px;">
        <h1 style="color: #dc2626;">Digital Printing Management</h1>
...
const generateInvoiceEmail = (customerName, order, invoiceUrl) => {
  return `
    <div style="font-family: Arial, sans-serif; max-width: 700px; margin: 0 auto; padding: 20px;">
      <div style="text-align: center; margin-bottom: 30px;">
        <h1 style="color: #059669;">First Promovier</h1>
        ...
        <div style="background: white; padding: 20px; border-radius: 6px; margin: 20px 0;">
          ...
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr style="border-bottom: 1px solid #d1fae5;">
              ...
              <td style="padding: 8px 0; color: #047857; font-weight: bold;">₹${order.final_amount || order.total}</td>
            </tr>
            <tr style="border-bottom: 1px solid #d1fae5;">
...
const generateRejectionEmail = (customerName, order, rejectionReason) => {
  return `
    <div style="font-family: Arial, sans-serif; max-width: 700px; margin: 0 auto; padding: 20px;">
      <div style="text-align: center; margin-bottom: 30px;">
        <h1 style="color: #dc2626;">First Promovier</h1>
        ...
        <div style="background: white; padding: 20px; border-radius: 6px; margin: 20px 0;">
          ...
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr style="border-bottom: 1px solid #fecaca;">
              ...
              <td style="padding: 8px 0; color: #dc2626; font-weight: bold;">₹${order.final_amount || order.total}</td>
            </tr>
            <tr>
