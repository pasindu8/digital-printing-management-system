...
import { Users, UserPlus, Clock, Calendar, CheckCircle, XCircle, Plus, Edit, Trash2, Menu } from "lucide-react";
                    ...
                    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        <div className="flex items-center justify-center h-64">
                            <div className="text-center">
                                ...
                                <p className="mt-4 text-slate-600 font-medium">Loading HR data...</p>
                            </div>
                        </div>
                    </main>
                </div>
            ...
            <div className={`flex-1 transition-all duration-300 ${sidebarMinimized ? 'lg:ml-16' : 'lg:ml-64'}`}>
                ...
                <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="space-y-6">
                                ...
                                <Card className="relative bg-white/70 backdrop-blur-xl border border-white/20 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 group-hover:scale-105">
                                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <CardTitle className="text-sm font-semibold text-slate-700">Present Today</CardTitle>
                                        </div>
                                    </CardHeader>
                                    <CardContent>
                                        <div className="text-3xl font-bold text-slate-800 mb-2">
                        ...
                        {/* Search Bar */}
                            <div className="hidden md:flex items-center flex-1 w-[1140px] h-[100px] ml-8 bg-white/50 backdrop-blur-sm border border-white/20 rounded-2xl shadow-lg px-4">
                                <div className="relative flex-1 center">
                                    <input
                                        ...
                                        className="pl-8 bg-white/50 backdrop-blur-sm w-[600px]"
                                    />
                ...
                <Tabs defaultValue="employees" className="space-y-4 bg-white/70 backdrop-blur-xl border border-white/20 rounded-3xl p-6 shadow-xl">
                    <TabsList>
                                ...
                                <TableBody>
                                    {employees.filter(employee => {
                                        ...
                                        return (
                                            ...
                                            employee.employment?.position?.toLowerCase().includes(searchLower) ||
                                        ...
                                        <TableRow key={employee.employeeId || employee._userId || employee.personalInfo?.email}>
                                            ...
                                            <TableCell>
                                                <div className="">
                                                    <Button className="w-[90px] h-[35px] m-2" size="sm" onClick={() => clockIn(employee.employeeId)}>
                                                        Clock In
                                                    </Button>
                                                    <Button className="w-[90px] h-[35px]" size="sm" variant="outline" onClick={() => clockOut(employee.employeeId)}>
                                                        Clock Out
                                                    </Button><br></br>
                                                    <Button className="bg-[#1f7a1f] text-white m-2 w-[90px] h-[35px]" size="sm" variant="secondary" onClick={() => openEditDialog(employee)}>
                                                        Edit
                                                    </Button>
                                                    <Button className="w-[90px] h-[35px]" size="sm" variant="destructive" onClick={() => openDeleteDialog(employee)}>
                                                        Delete
                                                    </Button>
                                                </div>
                                            </TableCell>
                                            ...
                                            <TableRow key={salary._id || salary.salaryId}>
                                                ...
                                                <TableCell>
                                                    <div className="flex gap-2">
                                                        <Button 
                                                            size="sm" 
                                                            className="bg-[#1f7a1f] text-white"
                                                            variant="outline"
                                                            onClick={() => {
